...
abstract class BChart extends TElement
{
    ...
    public function __construct(String $name, String $database = null, String $model = null, array $fieldGroup = [], String $fieldValue = null, array $joins = [], $totalChart = 'sum', TCriteria $criteria = NULL)
    {
        ...
        $this->colors = ['#1abc9c', '#2ecc71', '#3498db', '#9b59b6', '#34495e', '#f1c40f', '#e67e22', '#e74c3c', '#95a5a6', '#16a085', '#27ae60', '#2980b9', '#8e44ad', '#2c3e50', '#f39c12', '#d35400', '#c0392b', '#7f8c8d', '#6182f7','#9084c3','#52812d','#7af8ba','#39953d','#de6a4','#1876a9','#ad4316','#5c1365','#8b7e65','#6ef53b','#aea561','#8a8fe8','#b0ab4c','#a3d22e','#8b4515','#5debbf','#6dca27','#9a535e','#2daacc','#102ac1','#40d4e9','#a7e34d','#2e7888','#d33da6','#84f86d','#fe0de0','#5a1c46','#4a98b1','#2092c4','#6f921d','#7a6ea','#805d46','#4669c1','#63f587','#325ca0','#1a782d','#9a5c25','#ec7dd8','#41acc3','#3abe6c','#bd65e2','#eca34c','#7c0239','#b38c7e','#726fa','#974bb6','#54c3ec','#6bfaa9','#a9b472','#953e18','#fb6524','#b4f5c1','#6eaa5d','#630b47','#47fc0','#93277c','#81fc8','#f1db2','#ad6bc0','#712269','#36f290','#e88da8','#fbadcd','#9f4923','#c0bdb4','#d592d','#9f707e','#8f2d42','#a5d6e0','#92866f','#43395e','#69c28b','#b96749','#7b2bc2','#ae70ac','#b9bf26','#9eb5c3','#4149d3','#b4deec','#a7c4b2','#58bab3','#875db2','#19c2f1','#19b670','#5b6aa4','#78661f','#830989','#19898f','#c3d27b','#7f4848','#ceb5fc','#1f620','#4fb154','#94debe','#f3e9a3','#e74431','#5f635a','#dfb39e','#3576a4'];
    ...
    public static function generate(...$charts)
    {
        ...
        {
            if (! $chart instanceof BIndicator && ! $chart instanceof BChart)
            {
    ...
    private function loadData()
    {
        ...
        {
            array_unshift($orders, (count($groups) + 1) . ' ' . $this->orderByValue );
        }
        ...
        $sql->addColumn("{$this->totalChart}({$this->fieldValue})");
