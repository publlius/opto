...
class AgendaCalendarForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Horário inicial:", '#ff0000', '14px', null)],[$horario_inicial],[new TLabel("Horário final:", '#ff0000', '14px', null)],[$horario_final]);
        $row3 = $this->form->addFields([new TLabel("Paciente:", null, '14px', null)],[$titulo]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TToast::show('success', "Horário agendado!", 'topRight', 'far:check-circle'); 
