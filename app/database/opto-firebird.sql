...
CREATE TABLE cad_paciente( 
      ...
      observacoes blob sub_type 1    DEFAULT NULL , 
      criado_em timestamp    DEFAULT NULL , 
      atualizado_em timestamp    DEFAULT NULL , 
      criado_por_id integer  (11)    DEFAULT NULL , 
      atualizado_por_id integer  (11)    DEFAULT NULL , 
 PRIMARY KEY (id)) ; 

CREATE TABLE lan_avaliacao( 
      id  integer generated by default as identity     NOT NULL , 
      data_avaliacao date    NOT NULL , 
      cad_paciente_id integer    NOT NULL , 
      idade_atual varchar  (255)    NOT NULL , 
      anamnese blob sub_type 1    NOT NULL , 
