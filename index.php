<head>
    <link rel="apple-touch-icon" sizes="192x192" href="https://sis.whap.com.br/opto/logo192.png">
</head>

<script>
    if("serviceWorker" in navigator) {
	    navigator.serviceWorker.register("https://sis.whap.com.br/opto/service-worker.js");
    }
</script>
