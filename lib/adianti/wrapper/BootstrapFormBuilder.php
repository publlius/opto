...
class BootstrapFormBuilder implements AdiantiFormInterface
{
    ...
    public static function wrapField($field, $display, $default_field_size = null)
    {
        ...
        $field_size = (is_object($object) && method_exists($object, 'getSize')) ? $field->getSize() : '100%';
        ...
        elseif($field instanceof TFormSeparator || $field instanceof BootstrapFormBuilder || $field instanceof TFieldList)
        {
